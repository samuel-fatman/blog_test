...
<html lang="en">
    ...
    <body>
        ...
        <!-- Main Content-->
  <form action="{{route('post_blog_submit')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="tag" id="exampleFormControlInput2" placeholder="tags">
  </div>
  <div class="form-group">
    <label for="category">Category</label>
    <select class="form-control" name="category" id="category">
        @foreach($categories as $category)
        <option value="{{$category->bango}}">{{$category->category1}}</option>
        @endforeach
    </select>
  </div>

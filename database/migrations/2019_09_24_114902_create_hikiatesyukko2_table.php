...
class CreateHikiatesyukko2Table extends Migration {
	...
	public function up()
	{
		Schema::create('hikiatesyukko2', function(Blueprint $table)
		{
			$table->integer('orderbango')->nullable()->default(1);
			$table->integer('syouhinbango')->nullable();
			$table->integer('yoteisu')->nullable();
			$table->dateTime('yoteibi')->nullable();
			$table->integer('syukkasu')->nullable();

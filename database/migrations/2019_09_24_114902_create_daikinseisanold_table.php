...
class CreateDaikinseisanoldTable extends Migration {
	...
	public function up()
	{
		Schema::create('daikinseisanold', function(Blueprint $table)
		{
			...
			$table->string('toiawasebango', 50)->nullable();

...
class CreateSyukkoTable extends Migration {
	...
	public function up()
	{
		Schema::create('syukko', function(Blueprint $table)
		{
			$table->integer('orderbango')->nullable()->index();
			...
			$table->integer('zaikometer')->nullable()->index();

...
class CreateOrderhenkan2Table extends Migration {
	...
	public function up()
	{
		Schema::create('orderhenkan2', function(Blueprint $table)
		{
			$table->integer('bango', true);
			$table->integer('kokyakubango')->nullable();
			$table->string('kokyakuorderbango', 50)->nullable();
